...
正文现包含 Q1、Q2、Q3、模型评价和结论。正文图按统一顺序编号：图1为Q1总览，图2—4为Q1三模态特征提取占位，图5为Q1时间对齐，图6—9为Q2，图10—12为Q3。图9已接入三种初始化的配对与误差分析结果；图10使用最新Q3架构图PDF，并保留PPTX可编辑源文件。Q1消融图与样本追踪图移至附录A1—A3。题目、摘要、关键词尚待最终定稿。新增的结果表使用现有冻结数据，表号自动顺延。
